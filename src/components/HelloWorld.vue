<template>
    <div class="hello">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="header-contact text-lg-left text-center">
                                <ul>
                                    <li><img src="assets/images/all-icon/map.png" alt="icon"><span>127/5 Mark street,
                                            New york</span></li>
        ...
        <section id="slider-part" class="slider-active">
            <div class="single-slider bg_cover pt-150" style="background-image: url(assets/images/slider/s-1.jpg)"
                data-overlay="4">
                <div class="container">
                    <div class="row">
            ...
            <div class="single-slider bg_cover pt-150" style="background-image: url(assets/images/slider/s-2.jpg)"
                data-overlay="4">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-7 col-lg-9">
            ...
            <div class="single-slider bg_cover pt-150" style="background-image: url(assets/images/slider/s-3.jpg)"
                data-overlay="4">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-7 col-lg-9">
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="about-cont">
                            <p>Lorem ipsum gravida nibh vel velit auctor aliquetn sollicitudirem quibibendum auci elit
                                ...
                                amet . Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt mauris. <br> <br>
                                ...
                                <li>
                                    <div class="singel-feature">
                                        ...
                                        <div class="cont">
                                            ...
                                            <p>Gravida nibh vel velit auctor aliquetn auci elit cons solliazcitudirem
                                                sem quibibendum sem nibhutis.</p>
                                        </div>
                                    </div> <!-- singel feature -->
                                </li>
                                <li>
                        ...
                        <div class="singel-testimonial">
                            ...
                            <div class="testimonial-cont">
                                <p>Aliquetn sollicitudirem quibibendum auci elit cons equat ipsutis sem nibh id elit.
                                    Duis sed odio sit amet sem nibh id elit sollicitudirem </p>
                                <h6>Rubina Helen</h6>
                        ...
                        <div class="singel-news mt-30">
                            ...
                            <div class="news-cont">
                                ...
                                <p>Lorem ipsum gravida nibh vel velit auctor aliquetn sollicitudirem quibibendum auci
                                    elit cons equat ipsutis sem nibh id elit. Duis sed odio sit amet nibh vulputate
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <div class="news-cont mt-30">
                                        ...
                                        <p>Gravida nibh vel velit auctor aliquetn sollicitudirem quibibendum auci elit
                                            cons vel.</p>
                                    </div>
                                </div>
                            </div> <!-- row -->
